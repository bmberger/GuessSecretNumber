...
public class GuessMyNumberV2
{
    public static void main(String[] args)
    {
        ...
        System.out.println("For testing... the secret number is: " + secretNumber);
        System.out.println();
        ...
        while(secretNumber != userGuess)
        {
            ...
            {
                System.out.print("Guess number " + userGuess + " is too HIGH. ");
            }
            else if (userGuess < secretNumber)
            {
                System.out.print("Guess number " + userGuess + " is too LOW. ");
            }
